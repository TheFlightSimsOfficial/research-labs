...
if [[ "${CONFIRM}" =~ ^[Yy]$ ]]; then
	...
	sudo pip install 'qiskit-aqua-interfaces==0.2.1'
	sudo pip install 'qiskit-braket-provider==0.0.3'
	sudo pip install 'qiskit-dynamics==0.4.0'
	sudo pip install 'qiskit-experiments==0.4.0'
	sudo pip install 'qiskit-finance==0.3.4'
	sudo pip install 'qiskit-ibm-provider==0.5.3'
	sudo pip install 'qiskit-ibm-runtime==0.9.4'
	sudo pip install 'qiskit-machine-learning==0.6.0'
	sudo pip install 'qiskit-nature-pyscf==0.1.1'
