...
if [[ "${CONFIRM}" =~ ^[Yy]$ ]]; then
	...
	sudo pip install 'conan==2.0.6'
	sudo pip install 'cvxpy==1.3.1'
	sudo pip install 'cytoolz==0.12.1'
	sudo pip install 'dbus-python==1.2.18'
	sudo pip install 'distributed==2023.5.1'
	...
	sudo pip install 'ibm-q-lab-server-extension==4.0.26'
	sudo pip install 'ibm-q-lab-ui-extensions==4.0.26'
	sudo pip install 'ibm-quantum-widgets==4.0.26'
	...
	sudo pip install 'jupyterlab-execute-time==2.3.0'
	...
	sudo pip install 'jupyterlab-limit-output==1.0.0'
	...
	sudo pip install 'jupyterlab-pyflyby==4.1.0'
	...
	sudo pip install 'onnxruntime==1.15.0'
	sudo pip install 'openpyxl==3.1.2'
	sudo pip install 'overrides==7.3.1'
	...
	sudo pip install 'qc-grader==0.15.3'
	sudo pip install 'qiskit-aqt-provider==0.4.3'
	sudo pip install 'qiskit-braket-provider==0.0.3'
	sudo pip install 'qiskit-experiments==0.4.0'
	sudo pip install 'qiskit-finance==0.3.4'
	sudo pip install 'qiskit-ibm-provider==0.5.0'
	sudo pip install 'qiskit-ibm-runtime==0.9.0'
	sudo pip install 'qiskit-ionq==0.4.0'
	sudo pip install 'qiskit-iqm==8.1'
	sudo pip install 'qiskit-machine-learning==0.6.0'
	sudo pip install 'qiskit-nature==0.6.0'
	sudo pip install 'qiskit-qasm3-import==0.2.0'
	sudo pip install 'qiskit-qir==0.3.1'
	sudo pip install 'qiskit-textbook==0.1.0'
	sudo pip install 'rich==13.3.5'
	sudo pip install 'scikit-build==0.17.5'
	sudo pip install 'scikit-image==0.20.0'
