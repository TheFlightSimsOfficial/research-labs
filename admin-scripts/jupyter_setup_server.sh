...
if [[ "${CONFIRM}" =~ ^[Yy]$ ]]; then
	...
	pip install 'conda-build==3.24.0'
	pip install 'conda-package-handling==2.0.2'
	...
	pip install 'pytorch-triton-rocm==2.0.2'
