(self.webpackChunk_quantum_lab_ui = self.webpackChunk_quantum_lab_ui || []).push([
    [461], {
        48325: (_t, Le, A) => {
            ...
            function ne() {
                return ne = Object.assign || function(s) {
                    for (var u = 1; u < arguments.length; u++) {
                        var c = arguments[u];
                        for (var n in c) Object.prototype.hasOwnProperty.call(c, n) && (s[n] = c[n])
                    }
                    return s
            ...
            function I(s, u) {
                ...
                if (Object.getOwnPropertySymbols) {
                    ...
                    for (p = 0; p < b.length; p++) n = b[p], !(u.indexOf(n) >= 0) && (!Object.prototype.propertyIsEnumerable.call(s, n) || (c[n] = s[n]))
                }
                return c
            }
            ...
            function m(s, u, c) {
                return u && ke(s.prototype, u), c && ke(s, c), s
            }
            ...
            function Y(s, u) {
                return Y = Object.setPrototypeOf || function(n, p) {
            ...
            function Ee(s, u) {
                return u && (U(u) === "object" || typeof u == "function") ? u : O(s)
            }
            ...
            function l(s, u, c) {
                return u in s ? Object.defineProperty(s, u, {
                    value: c,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
                ...
                re = function(s) {
                    ...
                    function c() {
                        ...
                        return n = u.call.apply(u, [this].concat(b)), l(O(n), "button", g().createRef()), l(O(n), "outerModal", g().createRef()), l(O(n), "innerModal", g().createRef()), l(O(n), "startTrap", g().createRef()), l(O(n), "endTrap", g().createRef()), l(O(n), "modalInstanceId", "modal-".concat(Be())), l(O(n), "modalLabelId", "".concat(T, "--modal-header__label--").concat(n.modalInstanceId)), l(O(n), "modalHeadingId", "".concat(T, "--modal-header__heading--").concat(n.modalInstanceId)), l(O(n), "modalBodyId", "".concat(T, "--modal-body--").concat(n.modalInstanceId)), l(O(n), "handleKeyDown", function(E) {
                            n.props.open && (E.which === 27 && n.props.onRequestClose(E), E.which === 13 && n.props.shouldSubmitOnEnter && n.props.onRequestSubmit(E))
                        }), l(O(n), "handleMousedown", function(E) {
                            n.innerModal.current && !n.innerModal.current.contains(E.target) && !(0, te.s)(E.target, n.props.selectorsFloatingMenus) && !n.props.preventCloseOnClickOutside && n.props.onRequestClose(E)
                        }), l(O(n), "handleBlur", function(E) {
                            var x = E.target,
                                $ = E.relatedTarget,
                                k = n.props,
                                F = k.open,
                            ...
                            x && x.focus()
                        }), l(O(n), "handleTransitionEnd", function(E) {
                            E.target === E.currentTarget && n.outerModal.current && n.outerModal.current.offsetWidth && n.outerModal.current.offsetHeight && n.beingOpen && (n.focusButton(E.currentTarget), n.beingOpen = !1)
                        }), n
                    }
                    return m(c, [{
                        key: "componentDidUpdate",
                        value: function(p) {
                            !p.open && this.props.open ? this.beingOpen = !0 : p.open && !this.props.open && (this.beingOpen = !1), (0, q.Z)(document.body, "".concat(T, "--body--with-modal-open"), this.props.open)
                        }
                    }, {
                        ...
                        value: function() {
                            var p, b, _ = this.props,
                                ...
                                fe = g().createElement("button", {
                                    className: "".concat(T, "--modal-close"),
                                    type: "button",
                                    onClick: ue,
                                    title: f,
                                    "aria-label": f,
                                    ref: this.button
                                }, g().createElement(we.dOq, {
                                    "aria-label": f,
                                    className: "".concat(T, "--modal-close__icon")
                                })),
                            ...
                            var nt = function() {
                                    return Array.isArray(W) && W.length <= 2 ? W.map(function(ze, We) {
                                        ...
                                        return g().createElement(Q.Z, {
                                            key: "".concat(z, "-").concat(We),
                                            kind: "secondary",
                                            onClick: Se
                                        }, z)
                                    }) : le ? g().createElement(Q.Z, {
                                        kind: "secondary",
                                        onClick: ce
                                    }, le) : null
                                },
                                rt = g().createElement("div", ne({
                                    ref: this.innerModal,
                                    role: "dialog"
                                }, X, {
                                    className: et,
                                    ...
                                    className: "".concat(T, "--modal-header")
                                }, k && fe, x && g().createElement("h2", {
                                    id: this.modalLabelId,
                                    className: "".concat(T, "--modal-header__label")
                                }, x), g().createElement("h3", {
                                    id: this.modalHeadingId,
                                    className: "".concat(T, "--modal-header__heading")
                                }, E), !k && fe), g().createElement("div", ne({
                                    id: this.modalBodyId,
                                    className: tt
                                }, me, {
                                    "aria-labelledby": Me
                                }), this.props.children), Ae && g().createElement("div", {
                                    className: "".concat(T, "--modal-content--overflow-indicator")
                                }), !k && g().createElement(Ye.Z, {
                                    className: Oe
                                }, g().createElement(nt, null), g().createElement(Q.Z, {
                                    kind: S ? "danger" : "primary",
                                    disabled: h,
                                    onClick: r,
                                    ref: this.button
                                }, ge)));
                            return g().createElement("div", ne({}, Je, {
                                onKeyDown: this.handleKeyDown,
                                onMouseDown: this.handleMousedown,
                                onBlur: this.handleBlur,
                                className: Qe,
                                role: "presentation",
                                onTransitionEnd: this.props.open ? this.handleTransitionEnd : void 0,
                                ref: this.outerModal
                            }), g().createElement("span", {
                                ref: this.startTrap,
                                tabIndex: "0",
                                role: "link",
                                className: "".concat(T, "--visually-hidden")
                            }, "Focus sentinel"), rt, g().createElement("span", {
                                ref: this.endTrap,
                                tabIndex: "0",
                                role: "link",
                                className: "".concat(T, "--visually-hidden")
            ...
            l(re, "propTypes", (v = {
                ...
                if (u.secondaryButtons) {
                    ...
                    u[c].forEach(function(b) {
                        d().checkPropTypes(p, b, c, n)
                    })
                }
                return null
            }), l(v, "selectorPrimaryFocus", d().string), l(v, "selectorsFloatingMenus", d().arrayOf(d().string)), l(v, "shouldSubmitOnEnter", d().bool), l(v, "size", d().oneOf(["xs", "sm", "md", "lg"])), v)), l(re, "defaultProps", {
        ...
        91569: function(_t) {
            ...
            (function(Le, A) {
                ...
                function Le(r) {
                    if (Array.isArray(r)) {
                        for (var o = 0, f = Array(r.length); o < r.length; o++) f[o] = r[o];
                        return f
                ...
                q || (q = function(o, f, h) {
                    ...
                    return new(Function.prototype.bind.apply(o, [null].concat(Le(f))))
                });
                ...
                function H(r) {
                    return function(o) {
                        for (var f = arguments.length, h = Array(f > 1 ? f - 1 : 0), S = 1; S < f; S++) h[S - 1] = arguments[S];
                        return q(r, o, h)
                    }
                }
                ...
                function ke(r) {
                    return function() {
                        for (var o = arguments.length, f = Array(o), h = 0; h < o; h++) f[h] = arguments[h];
                        return Q(r, f)
                    }
                }
                ...
                function Y(r, o) {
                    for (; r !== null;) {
                        var f = g(r, o);
                        if (f) {
                            if (f.get) return H(f.get);
                            if (typeof f.value == "function") return H(f.value)
                        }
                        r = Ne(r)
                    }
                ...
                var Fe = R(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
                    ...
                    x = P(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
                    $ = P(/^html$/i),
                    k = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(r) {
                        return typeof r
                    } : function(r) {
                ...
                var le = function() {
                    ...
                    ge = function(o, f) {
                        ...
                        try {
                            return o.createPolicy(ae, {
                                createHTML: function(be) {
                                    return be
                                }
                            })
                        } catch {
                            return console.warn("TrustedTypes policy " + ae + " could not be created."), null
                        }
                    };
                ...
                function se() {
                    ...
                    var G = ge(Je, f),
                        ...
                        We = {};
                    try {
                        We = K(h).documentMode ? h.documentMode : {}
                    } catch {}
                    var z = {};
                    ...
                    var Se = c,
                        ...
                        M = Object.seal(Object.create(null, {
                            tagNameCheck: {
                                writable: !0,
                                configurable: !1,
                                enumerable: !0,
                    ...
                    var Zt = function(e) {
                            ...
                            if (e.namespaceURI === J) {
                                if (t.namespaceURI === dt && !Nt[y] || t.namespaceURI === mt && !It[y]) return !1;
                                var N = m({}, ["title", "style", "font", "a", "script"]);
                                return !vt[a] && (N[a] || !je[a])
                            }
                            return !1
                        },
                        j = function(e) {
                        ...
                        Pt = function(e) {
                            ...
                            if ($e === J) try {
                                t = new yt().parseFromString(N, _e)
                            } catch {}
                            if (!t || !t.documentElement) {
                                t = X.createDocument($e, "template", null);
                                try {
                                    t.documentElement.innerHTML = pt ? "" : N
                                } catch {}
                            }
                        ...
                        xt = function(e) {
                            return nt.call(e.ownerDocument || e, e, Ue.SHOW_ELEMENT | Ue.SHOW_COMMENT | Ue.SHOW_TEXT, null, !1)
                        },
                        qt = function(e) {
                            return e instanceof Ae && (typeof e.nodeName != "string" || typeof e.textContent != "string" || typeof e.removeChild != "function" || !(e.attributes instanceof He) || typeof e.removeAttribute != "function" || typeof e.setAttribute != "function" || typeof e.namespaceURI != "string" || typeof e.insertBefore != "function")
                        },
                        Ce = function(e) {
                            return (typeof W > "u" ? "undefined" : k(W)) === "object" ? e instanceof W : e && (typeof e > "u" ? "undefined" : k(e)) === "object" && typeof e.nodeType == "number" && typeof e.nodeName == "string"
                        },
                        Z = function(e, t, a) {
                            !z[e] || Ye(z[e], function(y) {
                                y.call(o, t, a, ye)
                            })
                        },
                        kt = function(e) {
                            ...
                            if (Z("uponSanitizeElement", e, {
                                    tagName: a,
                                    allowedTags: D
                                }), !Ce(e.firstElementChild) && (!Ce(e.content) || !Ce(e.content.firstElementChild)) && I(/<[/\w]/g, e.innerHTML) && I(/<[/\w]/g, e.textContent) || a === "select" && I(/<template/i, e.innerHTML)) return j(e), !0;
                            if (!D[a] || De[a]) {
                            ...
                            return e instanceof be && !Zt(e) || (a === "noscript" || a === "noembed") && I(/<\/no(script|embed)/i, e.innerHTML) ? (j(e), !0) : (de && e.nodeType === 3 && (t = e.textContent, t = U(t, Se, " "), t = U(t, at, " "), e.textContent !== t && (ee(o.removed, {
                                element: e.cloneNode()
                            }), e.textContent = t)), Z("afterSanitizeElements", e, null), !1)
                        },
                        Ft = function(e, t, a) {
                            if (Mt && (t === "id" || t === "name") && (a in h || a in jt)) return !1;
                            if (!(lt && !it[t] && I(zt, t))) {
                                if (!(At && I(Wt, t))) {
                                    if (!C[t] || it[t]) {
                                        if (!(Bt(e) && (M.tagNameCheck instanceof RegExp && I(M.tagNameCheck, e) || M.tagNameCheck instanceof Function && M.tagNameCheck(e)) && (M.attributeNameCheck instanceof RegExp && I(M.attributeNameCheck, t) || M.attributeNameCheck instanceof Function && M.attributeNameCheck(t)) || t === "is" && M.allowCustomizedBuiltInElements && (M.tagNameCheck instanceof RegExp && I(M.tagNameCheck, a) || M.tagNameCheck instanceof Function && M.tagNameCheck(a)))) return !1
                                    } else if (!ft[t]) {
                                        if (!I(ot, U(a, Et, ""))) {
                                            if (!((t === "src" || t === "xlink:href" || t === "href") && e !== "script" && v(a, "data:") === 0 && Dt[e])) {
                                                if (!(Ot && !I(Gt, U(a, Et, "")))) {
                                                    if (a) return !1
                                                }
                                            }
                            ...
                            if (!!w) {
                                ...
                                for (N = w.length; N--;) {
                                    ...
                                    if (a = ne(t.value), y = ie(B), L.attrName = y, L.attrValue = a, L.keepAttr = !0, L.forceKeepAttr = void 0, Z("uponSanitizeAttribute", e, L), a = L.attrValue, !L.forceKeepAttr && (wt(B, e), !!L.keepAttr)) {
                                        ...
                                        if (!!Ft(Vt, y, a)) try {
                                            Ht ? e.setAttributeNS(Ht, B, a) : e.setAttribute(B, a), Pe(o.removed)
                                        } catch {}
                                    }
                                }
                    ...
                    return o.sanitize = function(i, e) {
                        var t = void 0,
                            ...
                            N = void 0,
                            w = void 0;
                        if (pt = !i, pt && (i = "<!-->"), typeof i != "string" && !Ce(i)) {
                            if (typeof i.toString != "function") throw Te("toString is not a function");
                            if (i = i.toString(), typeof i != "string") throw Te("dirty is not a string, aborting")
                        }
                        if (!o.isSupported) {
                            if (k(r.toStaticHTML) === "object" || typeof r.toStaticHTML == "function") {
                                if (typeof i == "string") return r.toStaticHTML(i);
                                if (Ce(i)) return r.toStaticHTML(i.outerHTML)
                            }
                            return i
                        }
                        if (st || ht(e), o.removed = [], typeof i == "string" && (Re = !1), Re) {
                            if (i.nodeName) {
                                var L = ie(i.nodeName);
                                if (!D[L] || De[L]) throw Te("root node is forbidden and cannot be sanitized in-place")
                            }
                        } else if (i instanceof W) t = Pt("<!---->"), a = t.ownerDocument.importNode(i, !0), a.nodeType === 1 && a.nodeName === "BODY" || a.nodeName === "HTML" ? t = a : t.appendChild(a);
                        else {
                            if (!pe && !de && !oe && i.indexOf("<") === -1) return G && Ke ? G.createHTML(i) : i;
                            if (t = Pt(i), !t) return pe ? null : Ke ? Me : ""
                        }
                        t && ut && j(t.firstChild);
...
` + B), de && (B = U(B, Se, " "), B = U(B, at, " ")), G && Ke ? G.createHTML(B) : B
                        ...
                        typeof e == "function" && (z[i] = z[i] || [], ee(z[i], e))
